...
const EditPropertyModal = ({ isOpen, onClose, onSubmit, id }) => {
    ...
    const { addingProperty, addProperty, getSingleProperty, updateProperty } = useContext(PropertyContext)
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            ...
            setflierPreview(property.flier)
        }
        fetchProduct()
    }, [id])
    ...
    const handleSubmit = (e) => {
        ...
        if (!adminid) return
        updateProperty(adminid, id, formData);
        // setFormData({
        //     name: "",
        //     price: "",
        //     location: "",
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6">
                            Fill in the details below to edit this property.
                        </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3 mt-4">
                                ...
                                <Button type="submit " disabled={addingProperty} variant="primary">
                                    {addingProperty ? "Processing" : "Update Property"}
                                </Button>
                            </div>
                        </form>
                    </motion.div>
