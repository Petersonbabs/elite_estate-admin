  ...
  return <footer className="bg-[#3f1403] text-white">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <img src="/WhatsApp_Image_2025-08-15_at_11.01.52_PM.jpg" alt="FRN Logo" className="h-16 mb-4" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/dashboard" className="text-gray-300 hover:text-[#ec9a4e] transition-colors">
                  Member Dashboard
                </Link>
              </li>
            </ul>
